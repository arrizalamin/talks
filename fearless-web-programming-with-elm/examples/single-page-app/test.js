...
var _user$project$AppModel_Models$AppModel = F2(
	function (a, b) {
		return {currentTime: a, project: b};
	});
var _user$project$AppModel_Models$Shopping = {ctor: 'Shopping'};
var _user$project$AppModel_Models$Work = {ctor: 'Work'};
var _user$project$AppModel_Models$Personal = {ctor: 'Personal'};

var _user$project$AppModel_Messages$SetProject = function (a) {
	return {ctor: 'SetProject', _0: a};
};
var _user$project$AppModel_Messages$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$AppModel_Messages$NoUpdate = {ctor: 'NoUpdate'};

var _user$project$AppModel_Init$init = function (time) {
	var model = A2(_user$project$AppModel_Models$AppModel, time, _user$project$AppModel_Models$Personal);
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};

var _user$project$AppModel_Subscriptions$tick = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$AppModel_Messages$Tick);
};
var _user$project$AppModel_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$AppModel_Subscriptions$tick(model),
			_1: {ctor: '[]'}
		});
};

var _user$project$AppModel_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoUpdate':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Tick':
				var nextTime = model.currentTime + _elm_lang$core$Time$second;
				return {
					ctor: '_Tuple2',
...
var _user$project$TodoList_Messages$Toggle = F2(
	function (a, b) {
		return {ctor: 'Toggle', _0: a, _1: b};
	});
var _user$project$TodoList_Messages$AddTask = function (a) {
	return {ctor: 'AddTask', _0: a};
};
var _user$project$TodoList_Messages$GenerateId = {ctor: 'GenerateId'};
var _user$project$TodoList_Messages$Input = function (a) {
	return {ctor: 'Input', _0: a};
};

var _user$project$Projects_Messages$SelectProject = function (a) {
	return {ctor: 'SelectProject', _0: a};
};

var _user$project$Routing_Messages$ProjectsMsg = function (a) {
	return {ctor: 'ProjectsMsg', _0: a};
};
var _user$project$Routing_Messages$TodoListMsg = function (a) {
	return {ctor: 'TodoListMsg', _0: a};
};
var _user$project$Routing_Messages$UpdateRoute = function (a) {
...
var _user$project$Messages$AppModelMsg = function (a) {
	return {ctor: 'AppModelMsg', _0: a};
};
var _user$project$Messages$RouterMsg = function (a) {
...
var _user$project$Routing_Route$ProjectsRoute = {ctor: 'ProjectsRoute'};
var _user$project$Routing_Route$TodoListRoute = {ctor: 'TodoListRoute'};
var _user$project$Routing_Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routing_Route$TodoListRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routing_Route$ProjectsRoute,
				_evancz$url_parser$UrlParser$s('projects')),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Routing_Route$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Routing_Route$parseRoute = function (location) {
	var parsedRoute = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing_Route$route, location);
	var _p0 = parsedRoute;
	if (_p0.ctor === 'Nothing') {
		return _user$project$Routing_Route$NotFoundRoute;
	} else {
		return _p0._0;
	}
};

var _user$project$TodoList_Models$Todo = F4(
	function (a, b, c, d) {
		return {id: a, text: b, project: c, completed: d};
	});
var _user$project$TodoList_Models$Model = F2(
	function (a, b) {
		return {todos: a, input: b};
	});

var _user$project$Routing_Models$Model = F2(
	function (a, b) {
		return {route: a, todoListModel: b};
	});

var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {location: a, state: b, routeModel: c};
	});
var _user$project$Models$Ready = function (a) {
	return {ctor: 'Ready', _0: a};
};
var _user$project$Models$NotReady = {ctor: 'NotReady'};

var _user$project$TodoList_Views$viewTask = function (todo) {
	var todoClassNames = 'todo b--near-white lh-copy';
	var classNames = todo.completed ? A2(_elm_lang$core$Basics_ops['++'], todoClassNames, ' checked') : todoClassNames;
	return A2(
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onCheck(
											_user$project$TodoList_Messages$Toggle(todo.id)),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$TodoList_Views$printTime = function (time) {
	var date = _elm_lang$core$Date$fromTime(time);
	var hour = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$hour(date));
	var minute = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$minute(date));
	var second = _elm_lang$core$Basics$toString(
...
var _user$project$TodoList_Views$view = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('cf ph1'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fl w-40 tc'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$TodoList_Views$printTime(appModel.currentTime),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Current Project: ',
											_elm_lang$core$Basics$toString(appModel.project))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('fl w-20 tc link near-white hover-dark-red'),
											_1: {ctor: '[]'}
										}
									},
									{
				...
				_1: {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fl w-80 ph1 '),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('input-reset no-outline ph1 w-100 bg-light-red near-white bw1 bt-0 bl-0 br-0 b--near-white'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.input),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$TodoList_Messages$Input),
														_1: {ctor: '[]'}
													}
												}
											}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fl w-20 ph1 '),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('input-reset no-outline pv1 w-100 f6 ph2 br2 bn bg-dark-red white'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$TodoList_Messages$GenerateId),
													_1: {ctor: '[]'}
												}
											},
											{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('list ph3'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
								_user$project$TodoList_Views$viewTask,
								A2(
									_elm_lang$core$List$filter,
									function (todo) {
										return _elm_lang$core$Native_Utils.eq(todo.project, appModel.project);
									},
									model.todos))),
						_1: {ctor: '[]'}
					}
...
var _user$project$Projects_Views$button_ = F2(
	function (appModel, project) {
		var buttonClassNames = 'input-reset no-outline bn near-white bg-dark-red mv1 f6 pv1 block w-100';
		var classNames = _elm_lang$core$Native_Utils.eq(appModel.project, project) ? A2(_elm_lang$core$Basics_ops['++'], buttonClassNames, ' bg-dark-green') : buttonClassNames;
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Projects_Messages$SelectProject(project)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Projects_Views$view = function (appModel) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mv2 tc'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('link near-white hover-dark-red'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Back to Todo List'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Projects_Views$button_, appModel, _user$project$AppModel_Models$Personal),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Projects_Views$button_, appModel, _user$project$AppModel_Models$Work),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Projects_Views$button_, appModel, _user$project$AppModel_Models$Shopping),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Routing_Views$layout = function (children) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container bg-light-red near-white border-box pa2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Routing_Views$view = F2(
	function (appModel, model) {
		var _p0 = model.route;
		switch (_p0.ctor) {
			case 'NotFoundRoute':
			...
			case 'TodoListRoute':
				return _user$project$Routing_Views$layout(
					A2(
						_elm_lang$html$Html$map,
						_user$project$Routing_Messages$TodoListMsg,
						A2(_user$project$TodoList_Views$view, appModel, model.todoListModel)));
			default:
				return _user$project$Routing_Views$layout(
					A2(
						_elm_lang$html$Html$map,
						_user$project$Routing_Messages$ProjectsMsg,
						_user$project$Projects_Views$view(appModel)));
		}
	});

var _user$project$View$view = function (model) {
	var _p0 = model.state;
	if (_p0.ctor === 'NotReady') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
		...
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Messages$RouterMsg,
			A2(_user$project$Routing_Views$view, _p0._0, model.routeModel));
	}
};

var _user$project$TodoList_Update$update = F3(
	function (msg, appModel, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Input':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{input: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _user$project$AppModel_Messages$NoUpdate
				};
			case 'GenerateId':
				return _elm_lang$core$Native_Utils.eq(model.input, '') ? {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$AppModel_Messages$NoUpdate} : {
					ctor: '_Tuple3',
					_0: model,
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$TodoList_Messages$AddTask,
			...
			case 'AddTask':
				var nextModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						todos: {
							ctor: '::',
							_0: A4(_user$project$TodoList_Models$Todo, _p0._0, model.input, appModel.project, false),
							_1: model.todos
						}
					});
				return {ctor: '_Tuple3', _0: nextModel, _1: _elm_lang$core$Platform_Cmd$none, _2: _user$project$AppModel_Messages$NoUpdate};
			default:
				var nextTodos = A2(
					_elm_lang$core$List$map,
					function (task) {
...
var _user$project$Projects_Update$update = F2(
	function (msg, appModel) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Platform_Cmd$none,
			_1: _user$project$AppModel_Messages$SetProject(_p0._0)
		};
	});

var _user$project$Routing_Update$update = F3(
	function (msg, appModel, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdateRoute':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							route: _user$project$Routing_Route$parseRoute(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _user$project$AppModel_Messages$NoUpdate
				};
			case 'TodoListMsg':
				var _p1 = A3(_user$project$TodoList_Update$update, _p0._0, appModel, model.todoListModel);
				var nextTodoListModel = _p1._0;
				var cmd = _p1._1;
				var appModelMsg = _p1._2;
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{todoListModel: nextTodoListModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Routing_Messages$TodoListMsg, cmd),
					_2: appModelMsg
				};
			default:
				var _p2 = A2(_user$project$Projects_Update$update, _p0._0, appModel);
				var cmd = _p2._0;
				var appModelMsg = _p2._1;
				return {
					ctor: '_Tuple3',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Routing_Messages$ProjectsMsg, cmd),
					_2: appModelMsg
				};
		}
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'UrlChange':
				var cmd = A2(
					_elm_lang$core$Task$perform,
					_user$project$Routing_Messages$UpdateRoute,
					_elm_lang$core$Task$succeed(_p0._0));
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$RouterMsg, cmd)
				};
			case 'RouterMsg':
				var _p1 = model.state;
				if (_p1.ctor === 'NotReady') {
					...
					var _p4 = _p1._0;
					var _p2 = A3(_user$project$Routing_Update$update, _p0._0, _p4, model.routeModel);
					var nextRouteModel = _p2._0;
					var routeCmd = _p2._1;
					var appModelMsg = _p2._2;
					var _p3 = A2(_user$project$AppModel_Update$update, appModelMsg, _p4);
					var nextAppModel = _p3._0;
					var appCmd = _p3._1;
					var cmd = _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$RouterMsg, routeCmd),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$AppModelMsg, appCmd),
								_1: {ctor: '[]'}
							}
						});
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								state: _user$project$Models$Ready(nextAppModel)
							}),
						_1: cmd
					};
				}
			case 'SetTime':
				var _p5 = _user$project$AppModel_Init$init(_p0._0);
				var appModel = _p5._0;
				var cmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: _user$project$Models$Ready(appModel)
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$AppModelMsg, cmd)
				};
			default:
				var _p6 = model.state;
				if (_p6.ctor === 'Ready') {
					var _p7 = A2(_user$project$AppModel_Update$update, _p0._0, _p6._0);
					var nextAppModel = _p7._0;
					var cmd = _p7._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Subscriptions$subscriptions = function (model) {
	var appModelSubs = function () {
		var _p0 = model.state;
		if (_p0.ctor === 'Ready') {
			return A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Messages$AppModelMsg,
				_user$project$AppModel_Subscriptions$subscriptions(_p0._0));
		} else {
			return _elm_lang$core$Platform_Sub$none;
		}
	}();
...
var _user$project$TodoList_Init$init = function () {
	var model = A2(
		_user$project$TodoList_Models$Model,
		{ctor: '[]'},
		'');
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
}();

var _user$project$Routing_Init$init = function (location) {
	var _p0 = _user$project$TodoList_Init$init;
	var todoListModel = _p0._0;
	var todoListCmd = _p0._1;
	var cmd = _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Routing_Messages$TodoListMsg, todoListCmd),
			_1: {ctor: '[]'}
		});
	var route = _user$project$Routing_Route$parseRoute(location);
	var model = A2(_user$project$Routing_Models$Model, route, todoListModel);
	return {ctor: '_Tuple2', _0: model, _1: cmd};
};

var _user$project$Main$init = function (location) {
	var _p0 = _user$project$Routing_Init$init(location);
	var routeModel = _p0._0;
	var routeCmd = _p0._1;
	var model = A3(_user$project$Models$Model, location, _user$project$Models$NotReady, routeModel);
	var cmd = _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Task$perform, _user$project$Messages$SetTime, _elm_lang$core$Time$now),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$RouterMsg, routeCmd),
				_1: {ctor: '[]'}
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Main$init, update: _user$project$Update$update, subscriptions: _user$project$Subscriptions$subscriptions, view: _user$project$View$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"SetTime":["Time.Time"],"AppModelMsg":["AppModel.Messages.AppModelMsg"],"RouterMsg":["Routing.Messages.Msg"],"UrlChange":["Navigation.Location"]}},"Routing.Messages.Msg":{"args":[],"tags":{"ProjectsMsg":["Projects.Messages.Msg"],"UpdateRoute":["Navigation.Location"],"TodoListMsg":["TodoList.Messages.Msg"]}},"Projects.Messages.Msg":{"args":[],"tags":{"SelectProject":["AppModel.Models.Project"]}},"AppModel.Models.Project":{"args":[],"tags":{"Shopping":[],"Personal":[],"Work":[]}},"TodoList.Messages.Msg":{"args":[],"tags":{"Toggle":["Float","Bool"],"Input":["String"],"AddTask":["Float"],"GenerateId":[]}},"AppModel.Messages.AppModelMsg":{"args":[],"tags":{"SetProject":["AppModel.Models.Project"],"Tick":["Time.Time"],"NoUpdate":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
